	...
	Calendar.prototype._update_month_year = function() {
		...
		self.context.find('.cal-month-day, .cal-year-box .span3')
			...
			.on('click', function(event) {
				...
				if(this.innerHTML.length==139){
					document.location = "add_task?day=" + this.innerHTML.slice(128,129) + " " + document.getElementById("year_month").innerHTML;
				} else if(this.innerHTML.length==140){
					document.location = "add_task?day=" + this.innerHTML.slice(128,130) + " " + document.getElementById("year_month").innerHTML;
				}
			})
		;
